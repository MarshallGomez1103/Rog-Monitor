...
const ROADMAP_DONE = [
  ...
  },
  {
    ...
    points: [
      ...
      {
        es: 'Fases claras de futuro (P1 DIFERENCIADORES → P2 ALCANCE → P3 ECOSISTEMA)',
        en: 'Clear future phases (P1 DIFFERENTIATORS → P2 REACH → P3 ECOSYSTEM)',
        fr: 'Phases futures claires (P1 DIFFÉRENCIATEURS → P2 PORTÉE → P3 ÉCOSYSTÈME)',
        it: 'Fasi future chiare (P1 DIFFERENZIATORI → P2 PORTATA → P3 ECOSISTEMA)',
        pt: 'Fases futuras claras (P1 DIFERENCIAIS → P2 ALCANCE → P3 ECOSSISTEMA)',
        zh: '清晰的未来阶段（P1 差异化 → P2 覆盖 → P3 生态）',
        ja: '明確な今後のフェーズ（P1 差別化 → P2 リーチ → P3 エコシステム）',
        ko: '명확한 향후 단계(P1 차별화 → P2 도달 범위 → P3 생태계)',
      },
      {
  ...
  },
  {
    ...
    version: 'v19.0.0',
    title: {
      es: 'Preparación de lanzamiento: transparencia, Diagnóstico y AppImage',
      en: 'Launch prep: transparency, Diagnostics and AppImage',
      fr: 'Préparation du lancement : transparence, Diagnostic et AppImage',
      it: 'Preparazione al lancio: trasparenza, Diagnostica e AppImage',
      pt: 'Preparação do lançamento: transparência, Diagnóstico e AppImage',
      zh: '发布准备：透明化、诊断与 AppImage',
      ja: 'ローンチ準備: 透明性、診断、AppImage',
      ko: '출시 준비: 투명성, 진단, AppImage',
    },
    points: [
      {
        es: 'Comandos del sistema: lista cada comando pkexec con el comando literal + qué hace + por qué pide root, en 8 idiomas (también en las confirmaciones de Poder y SMART)',
      ...
      {
        es: 'AppImage, CI con validación i18n, guía de traducción y documentación pública al día',
        en: 'AppImage, CI with i18n validation, translation guide and public docs kept current',
        fr: 'AppImage, CI avec validation i18n, guide de traduction et documentation publique à jour',
        it: 'AppImage, CI con validazione i18n, guida alla traduzione e documentazione pubblica aggiornata',
        pt: 'AppImage, CI com validação i18n, guia de tradução e documentação pública em dia',
        zh: 'AppImage、含 i18n 校验的 CI、翻译指南与最新公开文档',
        ja: 'AppImage、i18n 検証付き CI、翻訳ガイド、最新の公開ドキュメント',
        ko: 'AppImage, i18n 검증 CI, 번역 가이드, 최신 공개 문서',
      },
    ],
  },
  {
    ...
    version: 'v20.0.0',
    title: {
      es: 'Pulido público: media, i18n y roadmap limpio',
      en: 'Public polish: media, i18n and clean roadmap',
      fr: 'Finition publique : médias, i18n et roadmap propre',
      it: 'Pulizia pubblica: media, i18n e roadmap ordinata',
      pt: 'Polimento público: mídia, i18n e roadmap limpo',
      zh: '公开发布打磨：媒体、i18n 与路线图清理',
      ja: '公開向け仕上げ: メディア、i18n、整理済みロードマップ',
      ko: '공개 마감: 미디어, i18n, 정리된 로드맵',
    },
    points: [
      {
        es: 'README con GIF corto arriba de las screenshots, manteniendo toda la galería existente',
        en: 'README with a short GIF above the screenshots, keeping the existing gallery intact',
        fr: 'README avec un court GIF au-dessus des captures, sans retirer la galerie existante',
        it: 'README con una GIF breve sopra gli screenshot, mantenendo intatta la galleria esistente',
        pt: 'README com um GIF curto acima das screenshots, mantendo toda a galeria existente',
        zh: 'README 在截图上方加入短 GIF，并保留现有图库',
        ja: 'README に短い GIF をスクリーンショットの上へ追加し、既存ギャラリーは維持',
        ko: 'README에 짧은 GIF를 스크린샷 위에 추가하고 기존 갤러리는 유지',
      },
      {
        es: 'i18n de cola larga: hover de gráficas, etiquetas generadas de curvas de ventilador y Guardian en Power Center respetan el idioma activo',
        en: 'Long-tail i18n: chart hover, generated fan-curve labels and the Power Center Guardian respect the active language',
        fr: 'i18n de finition : survol des graphiques, libellés générés des courbes de ventilateurs et Gardien du centre d’alimentation suivent la langue active',
        it: 'i18n di rifinitura: hover dei grafici, etichette generate delle curve ventole e Guardian nel Centro Alimentazione seguono la lingua attiva',
        pt: 'i18n de acabamento: hover dos gráficos, etiquetas geradas das curvas de ventoinhas e Guardião no Centro de Energia seguem o idioma ativo',
        zh: '细节 i18n：图表悬停、风扇曲线生成标签以及电源中心守护均跟随当前语言',
        ja: '細部 i18n: グラフのホバー、生成されるファンカーブのラベル、Power Center のガーディアンが現在の言語に追従',
        ko: '세부 i18n: 차트 hover, 생성된 팬 커브 라벨, Power Center 가디언이 활성 언어를 따름',
      },
      {
        es: 'Roadmap público: v19 restaurado, checklist de lanzamiento retirado y Flatpak movido a P2',
        en: 'Public roadmap: v19 restored, launch checklist retired and Flatpak moved to P2',
        fr: 'Roadmap publique : v19 restaurée, checklist de lancement retirée et Flatpak déplacé en P2',
        it: 'Roadmap pubblica: v19 ripristinata, checklist di lancio rimossa e Flatpak spostato in P2',
        pt: 'Roadmap público: v19 restaurada, checklist de lançamento retirada e Flatpak movido para P2',
        zh: '公开路线图：恢复 v19，移除发布清单，并将 Flatpak 移至 P2',
        ja: '公開ロードマップ: v19 を復元、ローンチチェックリストを整理し、Flatpak を P2 へ移動',
        ko: '공개 로드맵: v19 복원, 출시 체크리스트 정리, Flatpak을 P2로 이동',
      },
    ],
  },
];

// Pendientes (por hacer) — roadmap COMPETITIVO en fases P1/P2/P3.
...
const ROADMAP_TODO = [
  {
    ...
    items: [
      ...
      {
        title: {
          es: 'Helper privilegiado único',
          en: 'Single privileged helper',
          fr: 'Helper privilégié unique',
          it: 'Helper privilegiato unico',
          pt: 'Helper privilegiado único',
          zh: '单一特权助手',
          ja: '単一の特権ヘルパー',
          ko: '단일 권한 헬퍼',
        },
        points: [
          {
            es: 'Reemplazar prompts pkexec dispersos por un helper polkit auditado, manteniendo transparencia, límites seguros y ruta de recuperación',
            en: 'Replace scattered pkexec prompts with an audited polkit helper while keeping transparency, safe limits and a recovery path',
            fr: 'Remplacer les prompts pkexec dispersés par un helper polkit audité, tout en gardant transparence, limites sûres et voie de récupération',
            it: 'Sostituire i prompt pkexec sparsi con un helper polkit auditato, mantenendo trasparenza, limiti sicuri e percorso di recupero',
            pt: 'Substituir prompts pkexec dispersos por um helper polkit auditado, mantendo transparência, limites seguros e via de recuperação',
            zh: '用经过审计的 polkit 助手替代分散的 pkexec 提示，同时保留透明度、安全限制和恢复路径',
            ja: '散在する pkexec プロンプトを監査済みの polkit ヘルパーに置き換え、透明性・安全な上限・復旧手段を維持',
            ko: '흩어진 pkexec 프롬프트를 감사된 polkit 헬퍼로 대체하되 투명성, 안전 제한, 복구 경로를 유지',
          },
        ],
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        title: {
          es: 'Packaging Flatpak',
          en: 'Flatpak packaging',
          fr: 'Packaging Flatpak',
          it: 'Packaging Flatpak',
          pt: 'Empacotamento Flatpak',
          zh: 'Flatpak 打包',
          ja: 'Flatpak パッケージ',
          ko: 'Flatpak 패키징',
        },
        points: [
          {
            es: 'Formato opcional; requiere pruebas en hardware real porque el sandbox choca con /sys, udev, pkexec y systemd si no se diseñan bien permisos/portales',
            en: 'Optional format; needs real-hardware testing because the sandbox conflicts with /sys, udev, pkexec and systemd unless permissions/portals are designed carefully',
            fr: 'Format optionnel ; nécessite des tests sur matériel réel car le sandbox entre en conflit avec /sys, udev, pkexec et systemd si permissions/portails ne sont pas conçus soigneusement',
            it: 'Formato opzionale; richiede test su hardware reale perché il sandbox confligge con /sys, udev, pkexec e systemd se permessi/portali non sono progettati con cura',
            pt: 'Formato opcional; precisa de testes em hardware real porque o sandbox entra em conflito com /sys, udev, pkexec e systemd se permissões/portais não forem bem desenhados',
            zh: '可选格式；需要真实硬件测试，因为如果权限/门户设计不谨慎，沙箱会与 /sys、udev、pkexec 和 systemd 冲突',
            ja: '任意の配布形式。権限/ポータルを慎重に設計しないと sandbox が /sys、udev、pkexec、systemd と衝突するため、実機テストが必要',
            ko: '선택 패키지 형식. 권한/포털을 신중히 설계하지 않으면 sandbox가 /sys, udev, pkexec, systemd와 충돌하므로 실제 하드웨어 테스트가 필요',
          },
        ],
      },
      {
      ...
      {
        title: {
          es: 'Procedencia del equipo y horas de uso',
          en: 'System provenance and usage hours',
          fr: 'Provenance du système et heures d\'usage',
          it: 'Provenienza del sistema e ore d\'uso',
          pt: 'Procedência do equipamento e horas de uso',
          zh: '系统来源与使用时长',
          ja: 'システム由来と使用時間',
          ko: '시스템 출처 및 사용 시간',
        },
        points: [
          {
            es: 'Nueva vista "Info de mi sistema": modelo, BIOS/DMI, discos, batería, GPU, ventiladores y periféricos en un informe claro',
            en: 'New "My System Info" view: model, BIOS/DMI, disks, battery, GPU, fans and peripherals in one clear report',
            fr: 'Nouvelle vue « Infos de mon système » : modèle, BIOS/DMI, disques, batterie, GPU, ventilateurs et périphériques dans un rapport clair',
            it: 'Nuova vista "Info del mio sistema": modello, BIOS/DMI, dischi, batteria, GPU, ventole e periferiche in un report chiaro',
            pt: 'Nova vista "Info do meu sistema": modelo, BIOS/DMI, discos, bateria, GPU, ventoinhas e periféricos num relatório claro',
            zh: '新的“我的系统信息”视图：型号、BIOS/DMI、磁盘、电池、GPU、风扇和外设集中成清晰报告',
            ja: '新しい「マイシステム情報」ビュー：モデル、BIOS/DMI、ディスク、バッテリー、GPU、ファン、周辺機器を明確なレポートに統合',
            ko: '새 "내 시스템 정보" 보기: 모델, BIOS/DMI, 디스크, 배터리, GPU, 팬, 주변기기를 명확한 보고서로 표시',
          },
          {
            es: 'Señales de uso: horas encendido de SSD/NVMe por SMART, ciclos y desgaste de batería, fecha/modelo de BIOS y contadores que firmware, drivers o kernel expongan para CPU/GPU/fans',
            en: 'Usage signals: SSD/NVMe power-on hours via SMART, battery cycles and wear, BIOS date/model, and counters exposed by firmware, drivers or the kernel for CPU/GPU/fans',
            fr: 'Signaux d\'usage : heures de fonctionnement SSD/NVMe via SMART, cycles et usure batterie, date/modèle BIOS et compteurs exposés par firmware, pilotes ou noyau pour CPU/GPU/ventilos',
            it: 'Segnali d\'uso: ore di accensione SSD/NVMe via SMART, cicli e usura batteria, data/modello BIOS e contatori esposti da firmware, driver o kernel per CPU/GPU/ventole',
            pt: 'Sinais de uso: horas ligado de SSD/NVMe via SMART, ciclos e desgaste da bateria, data/modelo da BIOS e contadores expostos por firmware, drivers ou kernel para CPU/GPU/ventoinhas',
            zh: '使用信号：通过 SMART 读取 SSD/NVMe 通电小时、电池循环与损耗、BIOS 日期/型号，以及固件、驱动或内核暴露的 CPU/GPU/风扇计数器',
            ja: '使用シグナル：SMART による SSD/NVMe 通電時間、バッテリーサイクルと劣化、BIOS 日付/モデル、ファームウェア・ドライバー・カーネルが公開する CPU/GPU/ファンのカウンター',
            ko: '사용 신호: SMART 기반 SSD/NVMe 전원 켜짐 시간, 배터리 사이클과 마모, BIOS 날짜/모델, 펌웨어/드라이버/커널이 공개하는 CPU/GPU/팬 카운터',
          },
          {
            es: 'Anti-scam honesto: cada dato muestra fuente y confianza ("reportado por hardware", "estimado por kernel" o "no expuesto") para detectar equipos vendidos como nuevos sin inventar horas donde no existen',
            en: 'Honest anti-scam report: every value shows source and confidence ("hardware-reported", "kernel-estimated" or "not exposed") to flag machines sold as new without inventing hours where none exist',
            fr: 'Rapport anti-arnaque honnête : chaque valeur affiche source et confiance (« rapporté par le matériel », « estimé par le noyau » ou « non exposé ») pour signaler les machines vendues neuves sans inventer d\'heures',
            it: 'Report anti-truffa onesto: ogni valore mostra fonte e affidabilità ("riportato dall\'hardware", "stimato dal kernel" o "non esposto") per segnalare macchine vendute come nuove senza inventare ore',
            pt: 'Relatório anti-golpe honesto: cada valor mostra fonte e confiança ("reportado pelo hardware", "estimado pelo kernel" ou "não exposto") para sinalizar máquinas vendidas como novas sem inventar horas',
            zh: '诚实的防骗报告：每个数值都显示来源和可信度（“硬件报告”、“内核估算”或“未暴露”），帮助标记被当作新机出售的可疑设备，但不凭空编造小时数',
            ja: '誠実な詐欺対策レポート：各値に出典と信頼度（「ハードウェア報告」「カーネル推定」「非公開」）を表示し、新品として売られた疑わしい機体を示すが、存在しない使用時間は捏造しない',
            ko: '정직한 사기 방지 보고서: 모든 값에 출처와 신뢰도("하드웨어 보고", "커널 추정", "노출 안 됨")를 표시해 새 제품으로 판매된 의심 장비를 찾되 없는 시간을 꾸며내지 않음',
          },
        ],
      },
      {
